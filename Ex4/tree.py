...
class TreeClass:
    def __init__(self,particles):
        ...
        self.N_nodes = np.zeros((len(particles)))
        #
    ...
    def gforce(self,nodeid,pid,anglemax):
        ...
        if angle < anglemax or self.nodelist[nodeid].leaf == 1:
            ...
            if r == 0.0:
                ...
                force = mass * m * (cm - x) / (r**2 + epsilon**2)**1.5
            ...
            for iz in range(0,2):
                for iy in range(0,2):
                    for ix in range(0,2):
                        ...
                        temp = self.gforce(cid,pid,anglemax)
                        force[:] = force + temp
    ...
    def allgforces(self,anglemax):
        ...
        for pid in range(0, nrp):
            self.forces[pid][:] = self.gforce(0,pid,anglemax) / nrp**2
        #return N_nodes
